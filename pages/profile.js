...
const Profile = () => {
    ...
    const changeAvatar = (e) => {
        ...
        if(file.size > 6024 * 6024) //1mb
            return dispatch({type: 'NOTIFY', payload: {error: 'The largest image size is 6mb.'}})

        if(file.type !== "image/jpeg" && file.type !== "image/png") //6mb
                            ...
                            <tbody>
                                {
                                    orders.map(order => (
                                        <tr key={order._id}>
                                            ...
                                            <td className="p-2">NRP.{order.total}</td>
                                            <td className="p-2">
                                                {
                                                    order.delivered
